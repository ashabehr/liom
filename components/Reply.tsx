...
import {
  PlasmicReply,
  DefaultReplyProps
} from "./plasmic/liom_hamyar/PlasmicReply";
...
export interface ReplyProps extends DefaultReplyProps {}

function Reply_(props: ReplyProps, ref: HTMLElementRefOf<"div">) {
  ...
  return <PlasmicReply root={{ ref }} {...props} />;
}

const Reply = React.forwardRef(Reply_);
