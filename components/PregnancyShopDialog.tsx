...
function PregnancyShopDialog_(
  props: PregnancyShopDialogProps,
  ...
  return <PlasmicPregnancyShopDialog root={{ ref }} {...props} />;
}

const PregnancyShopDialog = React.forwardRef(PregnancyShopDialog_);
