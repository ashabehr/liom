...
import sty from "./PlasmicLineClomp2.module.css"; // plasmic-import: zuZ91wbmspN9/css
  ...
  return (
    ...
    >
      ...
      {(
        ...
        <div
          className={classNames("all", "__wab_text", sty.text__hREwN, {
            [sty.textmore__hREwNwsbDw]: hasVariant($state, "more", "more")
          })}
          onClick={async event => {
            const $steps = {};
      ...
      {(
        ...
        <div
          className={classNames("all", "__wab_text", sty.text__cN70S, {
            [sty.textmore__cN70SwsbDw]: hasVariant($state, "more", "more")
          })}
          onClick={async event => {
            const $steps = {};
