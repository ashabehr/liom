      ...
      {renderPlasmicSlot({
        defaultContents: (
          <React.Fragment>
            ...
            <div className={classNames("all", sty.freeBox___9Bdgo)}>
              {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                ...
                return (
                  <div
                    className={classNames("all", sty.freeBox__h4YpV)}
                    key={currentIndex}
                  >
                    <div className={classNames("all", sty.freeBox__qF1JU)} />
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicMedisene__VariantsArgs, ReservedPropsType> &
