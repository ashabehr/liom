...
import sty from "./PlasmicMain3.module.css"; // plasmic-import: j_hR0f0gqi6e/css
...
export type PlasmicMain3__VariantMembers = {
  setting: "setting";
  subItem: "subItem";
  edit: "edit";
  cycle: "cycle";
...
export type PlasmicMain3__VariantsArgs = {
...
type VariantPropType = keyof PlasmicMain3__VariantsArgs;
export const PlasmicMain3__VariantProps = new Array<VariantPropType>(
  "setting",
  "subItem",
  "edit",
  "cycle",
...
export type PlasmicMain3__ArgsType = {};
type ArgPropType = keyof PlasmicMain3__ArgsType;
export const PlasmicMain3__ArgProps = new Array<ArgPropType>();

export type PlasmicMain3__OverridesType = {
  root?: Flex__<"div">;
  main?: Flex__<"div">;
...
export interface DefaultMain3Props {}
...
function PlasmicMain3__RenderFunc(props: {
  variants: PlasmicMain3__VariantsArgs;
  args: PlasmicMain3__ArgsType;
  overrides: PlasmicMain3__OverridesType;
  forNode?: string;
}) {
        ...
        >
          <div
            ...
            className={classNames(projectcss.all, sty.main, {
              ...
              [sty.mainreminderSetting2_cycle]:
                ...
                slot={
                  <React.Fragment>
                    {(() => {
                      try {
                        return (
                          !$state.notif && $state.footerMain.type == "calendar"
                        );
                      } catch (e) {
                        if (
                          e instanceof TypeError ||
          ...
          <Reveal
            className={classNames("__wab_instance", sty.reveal__plcxW, {
              [sty.revealcycle__plcxWtRwEd]: hasVariant(
                $state,
                "cycle",
                "cycle"
              ),
              [sty.revealedit__plcxW0J1ZH]: hasVariant($state, "edit", "edit"),
              [sty.revealreminderSetting2__plcxWa49Uw]: hasVariant(
                $state,
                "reminderSetting2",
                "reminderSetting2"
              ),
              [sty.revealsetting__plcxWh13CE]: hasVariant(
                $state,
                "setting",
                "setting"
              ),
              [sty.revealsubItem__plcxWaUdim]: hasVariant(
                $state,
                "subItem",
                "subItem"
              )
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicMain3__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicMain3__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicMain3__ArgProps,
          internalVariantPropNames: PlasmicMain3__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicMain3__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicMain3";
  } else {
    func.displayName = `PlasmicMain3.${nodeName}`;
  }
  return func;
}
...
export const PlasmicMain3 = Object.assign(
  // Top-level PlasmicMain3 renders the root element
  withUsePlasmicAuth(makeNodeComponent("root")),
  {
    ...
    // Metadata about props expected for PlasmicMain3
    internalVariantProps: PlasmicMain3__VariantProps,
    internalArgProps: PlasmicMain3__ArgProps,
