...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: AkxxCybrSuo0/component
  ...
  return (
    <BaseDialogTrigger
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button2
            className={classNames("__wab_instance", sty.button2__hx1Qa)}
            label={"Open Popover"}
          />
        ),
