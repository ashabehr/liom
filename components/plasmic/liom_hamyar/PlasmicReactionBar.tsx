      ...
      {renderPlasmicSlot({
        defaultContents: (
          <React.Fragment>
            ...
            <div
              className={classNames("all", sty.freeBox__nmWwr)}
              onClick={async event => {
                const $steps = {};
            ...
            >
              <Icon150Icon
                className={classNames("all", sty.svg__n56Df)}
                role={"img"}
              />

              <div className={classNames("all", "__wab_text", sty.text__dreMr)}>
                <React.Fragment>
                  {(() => {
                    try {
                      return $props.commet;
            ...
            <div className={classNames("all", sty.freeBox__bF70U)}>
              <Icon149Icon
                className={classNames("all", sty.svg__btzVf)}
                role={"img"}
              />

              <div className={classNames("all", "__wab_text", sty.text__nD5Tl)}>
                <React.Fragment>
                  {(() => {
                    try {
                      return $props.shair;
            ...
            <div className={classNames("all", sty.freeBox__biwE)}>
              <Icon147Icon
                className={classNames("all", sty.svg__rgMH)}
                role={"img"}
              />

              <div className={classNames("all", "__wab_text", sty.text__fBrRk)}>
                <React.Fragment>
                  {(() => {
                    try {
