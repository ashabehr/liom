...
import sty from "./PlasmicBoxselect.module.css"; // plasmic-import: t5hDjwCCdngb/css
    ...
    >
      ...
      {(hasVariant($state, "selected", "selected") ? true : false) ? (
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/liom_hamyar/images/image19.svg",
            fullWidth: 18,
            fullHeight: 18,
            aspectRatio: 1
          }}
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicBoxselect__VariantsArgs, ReservedPropsType> &
