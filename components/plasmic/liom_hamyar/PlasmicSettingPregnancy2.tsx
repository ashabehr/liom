...
import sty from "./PlasmicSettingPregnancy2.module.css"; // plasmic-import: x2UwC-mN2Vem/css
...
export type PlasmicSettingPregnancy2__VariantMembers = {
  dark: "dark";
};
export type PlasmicSettingPregnancy2__VariantsArgs = {
  dark?: SingleBooleanChoiceArg<"dark">;
};
type VariantPropType = keyof PlasmicSettingPregnancy2__VariantsArgs;
export const PlasmicSettingPregnancy2__VariantProps =
  new Array<VariantPropType>("dark");

export type PlasmicSettingPregnancy2__ArgsType = {};
type ArgPropType = keyof PlasmicSettingPregnancy2__ArgsType;
export const PlasmicSettingPregnancy2__ArgProps = new Array<ArgPropType>();

export type PlasmicSettingPregnancy2__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultSettingPregnancy2Props {}
...
function PlasmicSettingPregnancy2__RenderFunc(props: {
  variants: PlasmicSettingPregnancy2__VariantsArgs;
  args: PlasmicSettingPregnancy2__ArgsType;
  overrides: PlasmicSettingPregnancy2__OverridesType;
  forNode?: string;
}) {
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        initFunc: ({ $props, $state, $queries, $ctx }) => "click"
      },
      {
        path: "typeInterDate",
        type: "private",
            ...
            try {
              return (() => {
                if ($state.lastTime.data != "") {
                  var gy = parseInt($state.lastTime.gy);
                  var gm = parseInt($state.lastTime.gm);
                  var gd = parseInt($state.lastTime.gd);
                ...
                >
                  <div
                    className={classNames(
                      ...
                      {
                        [sty.freeBoxdark__gqa8No7WO5]: hasVariant(
                          $state,
                          "dark",
                          "dark"
                        )
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox___3QkJc)}
                  >
                    <Button
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__h3UR)}
                      onClick={async event => {
                        const $steps = {};
                  ...
                  $steps["updateLastTime"] = true
                    ? (() => {
                        const actionArgs = {
                          ...
                          operation: 0,
                          value: (() => {
                            return window.jalaali.toGregorian(
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicSettingPregnancy2__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicSettingPregnancy2__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicSettingPregnancy2__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicSettingPregnancy2__ArgProps,
          internalVariantPropNames: PlasmicSettingPregnancy2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicSettingPregnancy2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicSettingPregnancy2";
  } else {
    func.displayName = `PlasmicSettingPregnancy2.${nodeName}`;
  }
  return func;
}
...
export const PlasmicSettingPregnancy2 = Object.assign(
  // Top-level PlasmicSettingPregnancy2 renders the root element
  withUsePlasmicAuth(makeNodeComponent("root")),
  {
    ...
    // Metadata about props expected for PlasmicSettingPregnancy2
    internalVariantProps: PlasmicSettingPregnancy2__VariantProps,
    internalArgProps: PlasmicSettingPregnancy2__ArgProps,
...
export default PlasmicSettingPregnancy2;
/* prettier-ignore-end */
