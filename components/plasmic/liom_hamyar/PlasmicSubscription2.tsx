...
import sty from "./PlasmicSubscription2.module.css"; // plasmic-import: f_5OZPoRC_w4/css
    ...
    >
      <div
        className={classNames(
          ...
          sty.text__vFmuI,
          { [sty.textclick__vFmuIKw5XT]: hasVariant($state, "click", "click") }
        )}
      >
        <React.Fragment>
          {(() => {
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___6T9LC, {
          [sty.freeBoxclick___6T9LCKw5XT]: hasVariant($state, "click", "click")
        })}
      >
        {(() => {
          try {
          ...
          <div
            className={classNames(
              ...
              sty.text__yNoB,
              {
                [sty.textclick__yNoBKw5XT]: hasVariant($state, "click", "click")
              }
            )}
          >
            <React.Fragment>
        ...
        <div
          className={classNames(
            ...
            projectcss.__wab_text,
            sty.text__iCuZ,
            { [sty.textclick__iCuZKw5XT]: hasVariant($state, "click", "click") }
          )}
        >
        ...
        {(() => {
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__bSmaa, {
              [sty.freeBoxclick__bSmaaKw5XT]: hasVariant(
                $state,
                "click",
                "click"
              )
          ...
          >
            <div
              className={classNames(
                ...
                sty.text__tVm0W,
                {
                  [sty.textclick__tVm0WKw5XT]: hasVariant(
                    $state,
                    "click",
                    "click"
                  )
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    /* Specify args directly as props*/ Omit<
      PlasmicSubscription2__ArgsType,
      ReservedPropsType
    > &
