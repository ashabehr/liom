...
import sty from "./PlasmicSubscription2.module.css"; // plasmic-import: UEZZNXct214t/css
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <React.Fragment>
            <div className={classNames("all", "__wab_text", sty.text__oYTzq)}>
              <React.Fragment>
                {(() => {
                  try {
                    return $state.title;
            ...
            <div className={classNames("all", sty.freeBox__veqkj)}>
              <div className={classNames("all", "__wab_text", sty.text__ttBif)}>
                <React.Fragment>
                  {(() => {
                    try {
              ...
              <div className={classNames("all", "__wab_text", sty.text__onLbl)}>
                <React.Fragment>
                  {(() => {
                    try {
              ...
              <div className={classNames("all", sty.freeBox___4VaCu)}>
                <div
                  className={classNames("all", "__wab_text", sty.text___7Kddu)}
                >
                  <React.Fragment>
                    {(() => {
                      try {
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicSubscription2__VariantsArgs, ReservedPropsType> &
