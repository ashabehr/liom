...
import sty from "./PlasmicNitif2.module.css"; // plasmic-import: MCAKqEbtK9Qy/css
...
export type PlasmicNitif2__VariantMembers = {};
export type PlasmicNitif2__VariantsArgs = {};
type VariantPropType = keyof PlasmicNitif2__VariantsArgs;
export const PlasmicNitif2__VariantProps = new Array<VariantPropType>();

export type PlasmicNitif2__ArgsType = {
...
type ArgPropType = keyof PlasmicNitif2__ArgsType;
export const PlasmicNitif2__ArgProps = new Array<ArgPropType>(
  "onClick",
  "reportsSelect",
...
export type PlasmicNitif2__OverridesType = {
  frame49?: Flex__<"div">;
  frame25?: Flex__<"div">;
  frame48?: Flex__<"div">;
  frame50?: Flex__<"div">;
...
export interface DefaultNitif2Props {
  onClick?: (event: any) => void;
  reportsSelect?: any;
  onReportsSelectChange?: (val: string) => void;
  tabList?: any;
...
function PlasmicNitif2__RenderFunc(props: {
  variants: PlasmicNitif2__VariantsArgs;
  args: PlasmicNitif2__ArgsType;
  overrides: PlasmicNitif2__OverridesType;
  forNode?: string;
}) {
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__e5Rd7)}>
          <Line3Icon
            className={classNames(projectcss.all, sty.svg__gtk25)}
            role={"img"}
          />
        </div>
      </div>
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox___1CUiz)}>
          ...
          <div className={classNames(projectcss.all, sty.freeBox__eQ8UX)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
            ...
            <Icon26Icon
              className={classNames(projectcss.all, sty.svg__rPs2A)}
              role={"img"}
            />
          </div>
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicNitif2__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicNitif2__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicNitif2__ArgProps,
          internalVariantPropNames: PlasmicNitif2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicNitif2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "frame49") {
    func.displayName = "PlasmicNitif2";
  } else {
    func.displayName = `PlasmicNitif2.${nodeName}`;
  }
  return func;
}

export const PlasmicNitif2 = Object.assign(
  // Top-level PlasmicNitif2 renders the root element
  makeNodeComponent("frame49"),
  {
    ...
    // Metadata about props expected for PlasmicNitif2
    internalVariantProps: PlasmicNitif2__VariantProps,
    internalArgProps: PlasmicNitif2__ArgProps
  }
);

export default PlasmicNitif2;
/* prettier-ignore-end */
