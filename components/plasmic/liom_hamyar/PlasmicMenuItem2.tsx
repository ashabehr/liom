...
import sty from "./PlasmicMenuItem2.module.css"; // plasmic-import: u434J7t_Xxcu/css
  ...
  return (
    ...
    >
      <div
        ...
        className={classNames("all", sty.vuesaxLinearStickynote)}
      >
        <div
          data-plasmic-name={"vuesaxLinearStickynote2"}
          data-plasmic-override={overrides.vuesaxLinearStickynote2}
          className={classNames("all", sty.vuesaxLinearStickynote2)}
        >
          <MenuIcon
