...
import Checkbox2 from "../../Checkbox2"; // plasmic-import: qduDT_igMPpA/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: AhgoIztCTzjf/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__qW96O)}>
            <Checkbox2
              className={classNames("__wab_instance", sty.checkbox2__bRBx)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox2
              className={classNames("__wab_instance", sty.checkbox2__shRfc)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox2
              className={classNames("__wab_instance", sty.checkbox2__qXjiB)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
