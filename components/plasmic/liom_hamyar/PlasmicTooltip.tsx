...
function PlasmicTooltip__RenderFunc(props: {
  ...
  return (
    (() => {
      ...
      >
        <div className={classNames("all", sty.freeBox__rmcOu)}>
          <Icon378Icon
            className={classNames("all", sty.svg__pyCbz)}
            role={"img"}
            style={(() => {
              try {
          ...
          <div className={classNames("all", "__wab_text", sty.text__edhtz)}>
            <React.Fragment>
              {(() => {
                try {
          ...
          <Icon22Icon
            className={classNames("all", sty.svg___7DY51)}
            onClick={async event => {
              const $steps = {};
        ...
        <div className={classNames("all", "__wab_text", sty.text__eWqok)}>
          <div
        ...
        <div className={classNames("all", sty.freeBox__sZhCv)}>
          {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
            ...
            return (
              <div
                className={classNames("all", sty.freeBox__aCduM)}
                key={currentIndex}
                onClick={async event => {
                  const $steps = {};
              ...
              >
                <div
                  className={classNames("all", "__wab_text", sty.text__tjOi3)}
                  style={(() => {
                    try {
                      return {
                        color:
