...
import sty from "./PlasmicLine.module.css"; // plasmic-import: tYgE5kAlYGXB/css
...
export const PlasmicLine__VariantProps = new Array<VariantPropType>("active");

export type PlasmicLine__ArgsType = { style2?: any };
type ArgPropType = keyof PlasmicLine__ArgsType;
export const PlasmicLine__ArgProps = new Array<ArgPropType>("style2");
