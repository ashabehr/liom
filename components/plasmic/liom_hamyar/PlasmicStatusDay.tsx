  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
        ...
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => ({
          ...
          secretions: [
            ...
            },
            {
              value: "spotting",
              meaning: "لکه بینی",
              icon: "<svg width='25' height='25' viewBox='0 0 25 25' fill='none' xmlns='http://www.w3.org/2000/svg'>\r\n<g clip-path='url(#clip0_191_533)'>\r\n<mask id='mask0_191_533' style='mask-type:luminance' maskUnits='userSpaceOnUse' x='0' y='0' width='25' height='25'>\r\n<path d='M25 0H0V25H25V0Z' fill='white'/>\r\n</mask>\r\n<g mask='url(#mask0_191_533)'>\r\n<path d='M21.3388 3.66114C18.9779 1.30024 15.8389 0 12.5 0C9.16115 0 6.02214 1.30024 3.66114 3.66114C1.30024 6.02214 0 9.16115 0 12.5C0 15.8389 1.30024 18.9779 3.66118 21.3389C6.02214 23.6997 9.16115 25 12.5 25C15.8389 25 18.9779 23.6997 21.3389 21.3389C23.6997 18.9779 25 15.8389 25 12.5C25 9.16115 23.6997 6.02214 21.3388 3.66114ZM20.303 20.3031C18.2188 22.3873 15.4476 23.5352 12.5 23.5352C9.5524 23.5352 6.7812 22.3873 4.69697 20.3031C2.6127 18.2187 1.46484 15.4476 1.46484 12.5C1.46484 9.55245 2.6127 6.78125 4.69697 4.69692C6.7812 2.6127 9.5524 1.46484 12.5 1.46484C15.4476 1.46484 18.2188 2.6127 20.303 4.69692C22.3873 6.78125 23.5352 9.55245 23.5352 12.5C23.5352 15.4476 22.3873 18.2187 20.303 20.3031Z' fill='var(--plasmic-token-primary)'/>\r\n<path d='M15.2383 18.5192C15.2383 19.9945 14.0424 21.1904 12.5671 21.1904C11.0918 21.1904 9.89587 19.9945 9.89587 18.5192C9.89587 17.044 12.5671 13.5417 12.5671 13.5417C12.5671 13.5417 15.2383 17.044 15.2383 18.5192Z' stroke='var(--plasmic-token-primary)' stroke-miterlimit='10' stroke-linecap='round' stroke-linejoin='round'/>\r\n<path d='M10.5508 11.2275C10.5508 12.7028 9.35488 13.8988 7.87957 13.8988C6.40426 13.8988 5.20837 12.7028 5.20837 11.2275C5.20837 9.75229 7.87957 6.25 7.87957 6.25C7.87957 6.25 10.5508 9.75229 10.5508 11.2275Z' stroke='var(--plasmic-token-primary)' stroke-miterlimit='10' stroke-linecap='round' stroke-linejoin='round'/>\r\n<path d='M19.9258 11.2275C19.9258 12.7028 18.7299 13.8988 17.2546 13.8988C15.7793 13.8988 14.5834 12.7028 14.5834 11.2275C14.5834 9.75229 17.2546 6.25 17.2546 6.25C17.2546 6.25 19.9258 9.75229 19.9258 11.2275Z' stroke='var(--plasmic-token-primary)' stroke-miterlimit='10' stroke-linecap='round' stroke-linejoin='round'/>\r\n</g>\r\n</g>\r\n<defs>\r\n<clipPath id='clip0_191_533'>\r\n<rect width='25' height='25' fill='white'/>\r\n</clipPath>\r\n</defs>\r\n</svg>\r\n",
              iconselect:
          ...
          bleeding: [
            {
              value: "none",
              meaning: "خونریزی نداشتم",
              icon: "😊"
            },
            {
              value: "spotting",
              meaning: "لکه‌بینی خفیف و گذرا",
              icon: "🩸"
            },
            {
              value: "moderateBleeding",
            ...
            },
            {
              ...
              meaning: "خونریزی شدید یا همراه با درد شکم",
              icon: "🚨"
            }
          ],
          ...
          blurredVision: [
            {
              value: "clearVision",
              meaning: "دید کاملاً واضح",
              icon: "🧐"
            },
            {
              value: "occasionalBlur",
              meaning: "گاهی تاری دید",
              icon: "😐"
            },
            {
              value: "blurAtTimes",
              meaning: "تاری در بعضی ساعات",
              icon: "🌫️"
            },
            {
              value: "constantBlur",
              meaning: "تاری دید مداوم یا شدید",
              icon: "😵"
            }
          ],
          ...
          fever: [
            ...
            {
              value: "mildFever",
              meaning: "تب خفیف یا احساس گرما",
              icon: "😓"
            },
            {
              value: "highFeverWithChills",
              meaning: "تب بالا همراه با لرز",
              icon: "🥶"
            },
            {
              value: "persistentHighFever",
              meaning: "تب مداوم بیش از ۳۸ درجه",
              icon: "🔥"
            }
          ],
          ...
          heartbeat: [
            ...
            },
            {
              ...
              meaning: "گاهی تپش قلب خفیف داشتم",
              icon: "💓"
            },
            {
              value: "constantPalpitation",
              meaning: "تپش قلب مداوم و آزاردهنده",
              icon: "💔"
            },
            {
              value: "irregularOrDizzy",
              meaning: "ضربان نامنظم یا احساس سبکی سر",
              icon: "💫"
            }
          ],
          ...
          urination: [
            ...
            {
              value: "moreThanUsual",
              meaning: "زیادتر از معمول",
              icon: "💦"
            },
            {
              value: "mildBurning",
              meaning: "کمی سوزش هنگام ادرار",
              icon: "🔥"
            },
            {
              value: "persistentBurning",
              meaning: "سوزش و درد مداوم هنگام ادرار",
              icon: "😖"
            },
            {
              value: "frequentPainful",
              meaning: "نیاز مکرر به ادرار همراه با درد",
              icon: "🚻😣"
            }
          ],
          ...
          skinItch: [
            ...
            {
              value: "mildItch",
              meaning: "خارش خفیف در برخی نواحی",
              icon: "🩹"
            },
            {
              value: "persistentItch",
              meaning: "خارش مداوم و آزاردهنده",
              icon: "😣"
            },
            {
              value: "itchInPalmsAndSoles",
              meaning: "خارش شدید در کف دست‌ها یا پاها",
              icon: "🤚🦶"
            }
          ],
          ...
          shortnessOfBreath: [
            ...
            },
            {
              ...
              meaning: "گاهی احساس تنگی نفس",
              icon: "😤"
            },
            {
              value: "persistentBreathlessness",
              meaning: "تنگی نفس مداوم در فعالیت‌های روزانه",
              icon: "💨💪"
            },
            {
              value: "breathlessAtRest",
              meaning: "تنگی نفس شدید حتی در حالت استراحت",
              icon: "😰"
            }
          ],
          ...
          dizziness: [
            ...
            {
              value: "mildDizziness",
              meaning: "گاهی احساس سرگیجه خفیف",
              icon: "😵"
            },
            {
              value: "persistentDizziness",
              meaning: "سرگیجه مداوم در طول روز",
              icon: "😵‍💫"
            },
            {
              value: "fainting",
              meaning: "یک‌بار یا بیشتر دچار غش شدم",
              icon: "🤢🤕"
            }
          ]
        })
      ...
      },
      {
        ...
        type: "private",
        variableType: "number",
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => 8
      },
      {
        path: "button6.color",
        type: "private",
      ...
      },
      {
        ...
        initFunc: ({ $props, $state, $queries, $q, $ctx }) =>
          (() => {
            try {
              return ($state.inDay.todo_list || []).filter(
                item => item !== null
              );
            } catch (e) {
              if (
      ...
      },
      {
        ...
        type: "private",
        variableType: "text",
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => "white"
      },
      {
        path: "button14.color",
        type: "private",
          ...
          <Embed
            ...
            code={
              hasVariant(globalVariants, "screen", "mobile")
                ...
                : "<script>\r\n(function() {\r\n    var link = document.querySelector(\"link[rel='icon']\");\r\n    if (!link) {\r\n        link = document.createElement('link');\r\n        link.rel = 'icon';\r\n        document.head.appendChild(link);\r\n    }\r\n    link.href = 'https://site-assets.plasmic.app/1efb20da13dc901df2ae2f3b7a43de6e.ico';\r\n})();\r\n</script>\r\n<script src=\"https://apps.liom.app/jalaali.js\"></script>\r\n"
            }
          />
                    ...
                    <div
                      ...
                      onClick={async event => {
                        ...
                        if (
                          ...
                          $steps["updateMedicineOpendialog"] =
                            await $steps["updateMedicineOpendialog"];
                        }
                      }}
                    >
                      {
                    ...
                    <div
                      ...
                      onClick={async event => {
                        ...
                        if (
                          ...
                          $steps["updateTodoDialogOpendialog"] =
                            await $steps["updateTodoDialogOpendialog"];
                        }
                      }}
                    >
                      {
                    ...
                    <Button
                      ...
                      onClick={async event => {
                        ...
                        if (
                          ...
                          $steps["updateNumber2Open2"] =
                            await $steps["updateNumber2Open2"];
                        }
            ...
            <Button
              ...
              onClick={async event => {
                ...
                if (
                  ...
                  $steps["updateNumberOfMedicinValue"] =
                    await $steps["updateNumberOfMedicinValue"];
                }
                    ...
                    onChange={async (...eventArgs: any) => {
                      ...
                      (async event => {
                        ...
                        if (
                          ...
                          $steps["updateFilterMedicine"] =
                            await $steps["updateFilterMedicine"];
                        }
                      }).apply(null, eventArgs);
                    }}
                    showEndIcon={(() => {
                  ...
                  <div
                    ...
                    onClick={async event => {
                      ...
                      if (
                        ...
                        $steps["updateNumber3Opendialog"] =
                          await $steps["updateNumber3Opendialog"];
                      }
                    }}
                  />
                </div>
              ...
              <Button
                ...
                onClick={async event => {
                      ...
                      ? (() => {
                          const actionArgs = {
                            ...
                            value: {
                              ...
                              count: $state.numberOfMedicin.value
                            }
                          };
                          return (({
                            variable,
                  ...
                  if (
                    ...
                    $steps["updateSelectedMedicine"] =
                      await $steps["updateSelectedMedicine"];
                  }
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicStatusDay__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicStatusDay__ArgsType, ReservedPropsType> &
