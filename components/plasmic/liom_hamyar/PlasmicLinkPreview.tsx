...
import sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: 3KDrMTdBtg6j/css
...
function PlasmicLinkPreview__RenderFunc(props: {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox__arDn9)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__lCz3J)}>
              <div className={classNames(projectcss.all, sty.freeBox___7WuwC)}>
                <h5
