...
function PlasmicHistory__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__jcaHo)}>
        <div className={classNames("all", sty.freeBox__jlkcL)}>
          <div className={classNames("all", "__wab_text", sty.text__i6GdK)}>
            {"\u0634\u0631\u0648\u0639 \u067e\u0631\u06cc\u0648\u062f"}
          </div>
          <div className={classNames("all", "__wab_text", sty.text__aBdco)}>
            {"\u067e\u0627\u06cc\u0627\u0646 \u062f\u0648\u0631\u0647"}
          </div>
        </div>
        {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
          ...
          return (
            <div
              className={classNames("all", sty.freeBox__b6Q1G)}
              key={moonIndex}
            >
              <div className={classNames("all", sty.freeBox___2LX6W)} />

              <div
                className={classNames("all", "__wab_text", sty.text___6Or0Y)}
              >
                <React.Fragment>
                  {(() => {
                    try {
              ...
              <div className={classNames("all", sty.freeBox__udBSs)}>
                {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                  (() => {
                    try {
                      return moon.periods;
                  ...
                  return (() => {
                    ...
                    return (
                      <BaseSlider
                        ...
                        {...child$Props}
                      >
                        <div className={classNames("all", sty.freeBox__mvuHw)}>
                          <div
                            className={classNames(
                              "all",
                              "__wab_text",
                        ...
                        <div
                          className={classNames("all", sty.freeBox___9DVrC)}
                          style={(() => {
                            try {
                ...
                {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                  ...
                  return (
                    <div
                      className={classNames("all", sty.freeBox__aO0Z8)}
                      key={cycleIndex}
                    >
                      <div
                        className={classNames(
                      ...
                      <div className={classNames("all", sty.freeBox__wGtJj)}>
                        {(_par =>
      ...
      >
        ...
        >
          <div className={classNames("all", sty.freeBox__zjJik)}>
            <XIcon
            ...
            <div className={classNames("all", "__wab_text", sty.text__c0TCm)}>
              {
