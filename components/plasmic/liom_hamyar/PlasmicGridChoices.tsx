...
export type PlasmicGridChoices__VariantMembers = {
  circl: "circl";
  rectangle: "rectangle";
};
export type PlasmicGridChoices__VariantsArgs = {
  circl?: SingleBooleanChoiceArg<"circl">;
  rectangle?: SingleBooleanChoiceArg<"rectangle">;
};
type VariantPropType = keyof PlasmicGridChoices__VariantsArgs;
export const PlasmicGridChoices__VariantProps = new Array<VariantPropType>(
  "circl",
  "rectangle"
);
...
type ArgPropType = keyof PlasmicGridChoices__ArgsType;
...
export type PlasmicGridChoices__OverridesType = {
  choices?: Flex__<"div">;
...
function PlasmicGridChoices__RenderFunc(props: {
  variants: PlasmicGridChoices__VariantsArgs;
  args: PlasmicGridChoices__ArgsType;
  overrides: PlasmicGridChoices__OverridesType;
  forNode?: string;
}) {
        ...
        return (
          <div
            className={classNames(projectcss.all, sty.freeBox__bXdcN, {
              ...
              [sty.freeBoxrectangle__bXdcN6O9Tk]: hasVariant(
                $state,
                "rectangle",
                "rectangle"
              )
          ...
          >
            {(() => {
              const child$Props = {
                ...
                slot: (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__nwx0L, {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicGridChoices__OverridesType,
  DescendantsType<T>
>;
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicGridChoices__ArgProps,
          internalVariantPropNames: PlasmicGridChoices__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicGridChoices__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "choices") {
    func.displayName = "PlasmicGridChoices";
  } else {
    func.displayName = `PlasmicGridChoices.${nodeName}`;
  }
  return func;
}

export const PlasmicGridChoices = Object.assign(
  // Top-level PlasmicGridChoices renders the root element
  makeNodeComponent("choices"),
  {
    ...
    // Metadata about props expected for PlasmicGridChoices
    internalVariantProps: PlasmicGridChoices__VariantProps,
    internalArgProps: PlasmicGridChoices__ArgProps
  }
);

export default PlasmicGridChoices;
/* prettier-ignore-end */
