...
export type Icon391IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Icon391Icon(props: Icon391IconProps) {
  ...
  return (
    ...
    >
      ...
      <g fill={"currentColor"}>
        <path
          d={
            "M12.554 16.506a.75.75 0 0 1-1.107 0l-4-4.375a.75.75 0 0 1 1.107-1.012l2.696 2.95V3a.75.75 0 0 1 1.5 0v11.068l2.697-2.95a.75.75 0 1 1 1.107 1.013z"
          }
        ></path>
