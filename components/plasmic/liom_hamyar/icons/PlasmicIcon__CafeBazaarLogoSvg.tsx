...
export type CafeBazaarLogoSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function CafeBazaarLogoSvgIcon(props: CafeBazaarLogoSvgIconProps) {
  ...
  return (
    <svg
      ...
      version={"1.1"}
      xmlSpace={"preserve"}
      viewBox={"61.47 25 518.68 240.99"}
      height={"1em"}
      style={{
        fill: "currentcolor",
    ...
    >
      ...
      <path
        d={
          "M169.1 199.36a15.37 15.37 0 01-15.37-15.37v-76.86a15.37 15.37 0 1130.74 0v76.86c0 8.48-6.88 15.37-15.37 15.37zm-53.8 15.37H76.86a15.37 15.37 0 110-30.74h30.75v-46.12a15.37 15.37 0 1130.74 0v53.81a23.07 23.07 0 01-23.05 23.05z"
        }
      ></path>

      <path
        d={
          "M207.46 245.48H169.1a15.37 15.37 0 110-30.74h30.75v-46.12a15.37 15.37 0 1130.74 0v53.73a23.15 23.15 0 01-23.13 23.13zm100-30.75h-38.23a23.28 23.28 0 01-23.26-23.26v-68.98a15.37 15.37 0 1130.74 0v61.49h30.75a15.37 15.37 0 110 30.75z"
        }
      ></path>
...
export default CafeBazaarLogoSvgIcon;
/* prettier-ignore-end */
