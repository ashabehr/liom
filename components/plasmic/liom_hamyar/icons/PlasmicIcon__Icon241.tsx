...
export type Icon241IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Icon241Icon(props: Icon241IconProps) {
  ...
  return (
    ...
    >
      ...
      <g mask={"url(#a)"}>
        <path fill={"url(#b)"} d={"M1169-1H0v1169h1169z"}></path>
      </g>
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            in2={"shape"}
            mode={"normal"}
            result={"effect1_innerShadow_9_2"}
          ></feBlend>
          ...
          <feBlend
            in2={"effect1_innerShadow_9_2"}
            mode={"normal"}
            result={"effect2_innerShadow_9_2"}
          ></feBlend>
        </filter>
