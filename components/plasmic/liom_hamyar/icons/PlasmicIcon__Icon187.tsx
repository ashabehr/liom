...
export function Icon187Icon(props: Icon187IconProps) {
  ...
  return (
    ...
    >
      ...
      <g mask={"url(#2P5oOr22z8qZa)"} fill={"#280056"}>
        <path
          d={
        ...
        <path
          d={
            "M17.34 10.949h-.07a6.86 6.86 0 01-6.11-5.78c-.06-.41.22-.79.63-.86.41-.06.79.22.86.63a5.372 5.372 0 004.78 4.52c.41.04.71.41.67.82-.05.38-.38.67-.76.67zm3.66 11.8H3c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h18c.41 0 .75.34.75.75s-.34.75-.75.75z"
          }
        ></path>
      </g>
    </svg>
