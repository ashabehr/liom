...
export type Icon279IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Icon279Icon(props: Icon279IconProps) {
  ...
  return (
    ...
    >
      ...
      <path
        fill={"currentColor"}
        d={
          "M8.25 5.75c-.41 0-.75-.34-.75-.75V2c0-.41.34-.75.75-.75S9 1.59 9 2v3c0 .41-.34.75-.75.75m7.5 0c-.41 0-.75-.34-.75-.75V2c0-.41.34-.75.75-.75s.75.34.75.75v3c0 .41-.34.75-.75.75M12 14.09c.52 0 .9-.31.9-.8 0-.5-.38-.79-.9-.79s-.9.29-.9.79c0 .49.38.8.9.8M12 17c.629 0 1.14-.416 1.14-.93s-.511-.93-1.14-.93c-.63 0-1.14.416-1.14.93s.51.93 1.14.93"
        }
      ></path>
