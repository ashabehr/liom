...
import HeaderV2 from "../../HeaderV2"; // plasmic-import: IYTV9bVTkPai/component
          ...
          <div className={classNames(projectcss.all, sty.freeBox___6CnX5)}>
            ...
            >
              <React.Fragment>
                {(() => {
                  try {
                    return $state.apiRequest.data.data.text;
                  } catch (e) {
                    if (
                      e instanceof TypeError ||
                      e?.plasmicType === "PlasmicUndefinedDataError"
...
const PlasmicDescendants = {
  root: ["root", "headerV2", "apiRequest", "lottie", "svg"],
  headerV2: ["headerV2"],
  apiRequest: ["apiRequest", "lottie", "svg"],
  lottie: ["lottie"],
  svg: ["svg"]
} as const;
