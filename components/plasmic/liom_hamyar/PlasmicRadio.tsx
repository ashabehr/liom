...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: 7gGRP6bmPdFU/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__ujPkd)}>
        <div className={classNames(projectcss.all, sty.freeBox__teiMp)} />
      </div>
      {renderPlasmicSlot({
