    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__ke06W, {
          ...
          [sty.freeBoxcolor_success_type_bordered__ke06W0OxpdRk1Jz]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__ke06WArs]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__ke06WzMZql]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__ke06W7MZY]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__ke06WwTiyJ]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__ke06WdEYka]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__ke06WRk1Jz]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__etlBi, {
            ...
            [sty.freeBoxcolor_neutral_type_soft__etlBiV83Z2WUtOm]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__etlBiX4H6Z]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__etlBizMZql]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__etlBiwTiyJ]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__etlBidEYka]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__etlBiRk1Jz]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___2T7T7, {
            ...
            [sty.freeBoxsize_extraLarge___2T7T7ZMZql]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___2T7T7WTiyJ]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___2T7T7DEYka]: hasVariant(
              $state,
              "size",
              "small"
            )
