...
export type PlasmicMainpan__VariantMembers = {
  page: "reports" | "tabPage" | "notifs" | "charts";
  user: "user";
  dataUser: "dataUser";
  chartViow: "chartViow";
};
export type PlasmicMainpan__VariantsArgs = {
...
type VariantPropType = keyof PlasmicMainpan__VariantsArgs;
export const PlasmicMainpan__VariantProps = new Array<VariantPropType>(
  "page",
  "user",
  "dataUser",
  "chartViow"
...
export type PlasmicMainpan__ArgsType = {
  header?: any;
  page2?: string;
  onPage2Change?: (val: string) => void;
};
type ArgPropType = keyof PlasmicMainpan__ArgsType;
export const PlasmicMainpan__ArgProps = new Array<ArgPropType>(
  "header",
  "page2",
  "onPage2Change"
);

export type PlasmicMainpan__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultMainpanProps {
  header?: any;
  page2?: string;
  onPage2Change?: (val: string) => void;
  page?: SingleChoiceArg<"reports" | "tabPage" | "notifs" | "charts">;
...
function PlasmicMainpan__RenderFunc(props: {
  variants: PlasmicMainpan__VariantsArgs;
  args: PlasmicMainpan__ArgsType;
  overrides: PlasmicMainpan__OverridesType;
  forNode?: string;
}) {
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => $props.dataUser
      },
      {
      ...
      },
      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => $props.chartViow
      },
      {
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicMainpan__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicMainpan__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicMainpan__ArgProps,
          internalVariantPropNames: PlasmicMainpan__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicMainpan__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicMainpan";
  } else {
    func.displayName = `PlasmicMainpan.${nodeName}`;
  }
  return func;
}

export const PlasmicMainpan = Object.assign(
  // Top-level PlasmicMainpan renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicMainpan
    internalVariantProps: PlasmicMainpan__VariantProps,
    internalArgProps: PlasmicMainpan__ArgProps
  }
);

export default PlasmicMainpan;
/* prettier-ignore-end */
