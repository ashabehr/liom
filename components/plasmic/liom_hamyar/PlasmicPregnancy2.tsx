...
import sty from "./PlasmicPregnancy2.module.css"; // plasmic-import: ESQYCy2CI8c6/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          {(
            ...
            <div
              className={classNames(projectcss.all, sty.freeBox__xCz7A, {
                [sty.freeBoxdarkMod__xCz7As3G1L]: hasVariant(
                  $state,
                  "darkMod",
                  "darkMod"
                )
            ...
            >
              ...
              <div className={classNames(projectcss.all, sty.freeBox___1Er0N)}>
                <div className={classNames(projectcss.all, sty.freeBox__b2IU)}>
                  <div
                    className={classNames(projectcss.all, sty.freeBox___81HoN)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
                    ...
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__fFwhH)}
                      displayHeight={"auto"}
              ...
              <div
                className={classNames(projectcss.all, sty.freeBox__cbvcd, {
                  [sty.freeBoxdarkMod__cbvcds3G1L]: hasVariant(
                    $state,
                    "darkMod",
                    "darkMod"
                  )
                  ...
                  return (
                    <Stack__
                      ...
                      className={classNames(
                        ...
                        sty.freeBox__xWl8R,
                        {
                          [sty.freeBoxdarkMod__xWl8Rs3G1L]: hasVariant(
                            $state,
                            "darkMod",
                            "darkMod"
                          )
                    ...
                    >
                      {(() => {
                        ...
                        <PlasmicImg__
                          alt={""}
                          className={classNames(sty.img___7DT3)}
                          displayHeight={"auto"}
                          displayMaxHeight={"none"}
                          displayMaxWidth={
                            hasVariant(globalVariants, "screen", "mobile")
                      ...
                      <div
                        className={classNames(
                          ...
                          sty.text__sk4XR,
                          {
                            [sty.textdarkMod__sk4XRs3G1L]: hasVariant(
                              $state,
                              "darkMod",
                              "darkMod"
                            )
          ...
          {(() => {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__xEwI)}>
              {(() => {
                try {
                  return true;
                } catch (e) {
