          ...
          {(() => {
            ...
            >
              ...
              >
                ...
                <div className={classNames(projectcss.all, sty.freeBox__m8Mf)}>
                  <Stack__
                    as={"div"}
                    hasGap={true}
                  ...
                  >
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__zov6B)}
                    >
                      <LottieWrapper
                        animationData={{
                          v: "5.7.4",
...
`;
              ...
              >
                {(
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__qex0W, {
                    ...
                    >
                      {hasVariant($state, "noPartner", "noPartner") ? (
                        <React.Fragment>
                          {(() => {
                            try {
                              return `هنوز هیچکس شما را به عنوان همیار قاعدگی خود انتخاب نکرده است. \nاز همیار خود بخواهید در بخش همیار در اپلیکیشن خود شماره شما را اضافه کند.  \nسپس روی دکمه زیر کلیک کنید.`;
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
                                e?.plasmicType === "PlasmicUndefinedDataError"
                ...
                {(
                  ...
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__ualnp, {
            ...
            >
              ...
              >
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__lpado)}
                >
