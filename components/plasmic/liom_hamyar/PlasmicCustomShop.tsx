    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <section className={classNames(projectcss.all, sty.section__rkdPv)}>
            <HeaderLiom
            ...
            >
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__xeihy)}
              >
                <XIcon
          ...
          <div className={classNames(projectcss.all, sty.freeBox__alRj)}>
            <RadioGrop
              className={classNames("__wab_instance", sty.radioGrop___8LPnk)}
              color={"light"}
              onClick={async event => {
                const $steps = {};
            ...
            <RadioGrop
              className={classNames("__wab_instance", sty.radioGrop__eIwjH)}
              color={"light"}
              onClick={async event => {
                const $steps = {};
            ...
            >
              {(() => {
                ...
                <Icon214Icon
                  className={classNames(projectcss.all, sty.svg__g1UzQ)}
                  role={"img"}
                />
              ) : null}
              <div
          ...
          {(() => {
            ...
            <Reveal
              className={classNames("__wab_instance", sty.reveal__h8R34)}
              effect={"fade"}
              triggerOnce={true}
            >
              <ApiRequest
              ...
              >
                ...
                >
                  ...
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__hB3Fp)}
                      displayHeight={"auto"}
                      displayMaxHeight={
                  ...
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__wwiV)}
                  >
                    {(_par =>
                      !_par ? [] : Array.isArray(_par) ? _par : [_par])(
                      (() => {
                      ...
                      const cart = __plasmic_item_0;
                      const cartIndex = __plasmic_idx_0;
                      return (
                        <Stack__
                          as={"div"}
                          hasGap={true}
                                                  ...
                                                  ? (() => {
                                                      const actionArgs = {
                                                        customFunction:
                                                          async () => {
                                                            return (() => {
                                                              return currentItem.items.forEach(
                                                                i => {
                                                                  const foundItem =
                                                                    $state.itemSelect.find(
                                                                      item =>
                                                                        item ===
                                                                        i.int_id
                                                                    );
                                                                  if (
                                                                    ...
                                                                    const index =
                                                                      $state.itemSelect.indexOf(
                                                                        foundItem
                                                                      );
                                                                    $state.itemSelect.splice(
                                                                      index,
                                                                      1
                                                                    );
                                                                  }
                                    ...
                                    >
                                      {(_par =>
                                        ...
                                        (__plasmic_item_2, __plasmic_idx_2) => {
                                          const item = __plasmic_item_2;
                                          const itemIndex = __plasmic_idx_2;
                                          return (
                                            <RadioGrop
                                              className={classNames(
                                                "__wab_instance",
                                                sty.radioGrop__atbaS
                                              )}
                                              color={"light"}
                                              key={itemIndex}
                                              onClick={async event => {
          ...
          {(() => {
            ...
            <Reveal
              className={classNames("__wab_instance", sty.reveal__jeHcn)}
              effect={"fade"}
              triggerOnce={true}
            >
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__abn3Y)}
              >
                {(() => {
                  try {
                    return $state.allowanceUser.length > 0;
                  ...
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__vggly)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__ar7Ua)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                ...
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__nnEqz)}
                >
                  <Icon215Icon
                    className={classNames(projectcss.all, sty.svg___3AjMm)}
                    onClick={async event => {
                      const $steps = {};
          ...
          >
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__kvpCn)}
            >
              <div
                className={classNames(
                  projectcss.all,
...
const PlasmicDescendants = {
  ...
  button13: ["button13"],
  modal: ["modal"],
  collapseMother: ["collapseMother", "checkbox"],
  checkbox: ["checkbox"],
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicCustomShop__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
