        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__ikTgu)}>
            ...
            <Embed
              ...
              code={
                "<script>\n\n    let isBlocked = false;\n\n    window.addEventListener('popstate', function(event) {\n\n      if (isBlocked) return;\n\n      const shouldBlockBackButton = window.plasmicParent?.state?.shouldBlockBackButton;\n      console.log(\"value:\" + shouldBlockBackButton);\n\n      if (shouldBlockBackButton) {\n        console.log('1\u0634\u0631\u0637 \u0628\u0631\u0642\u0631\u0627\u0631 \u0627\u0633\u062a! \u062f\u06a9\u0645\u0647 \u0628\u0627\u0632\u06af\u0634\u062a \u06a9\u0627\u0631 \u0646\u0645\u06cc\u200c\u06a9\u0646.');\n        event.preventDefault(); \n      } else {\n        console.log('1\u0634\u0631\u0637 \u0628\u0631\u0642\u0631\u0627\u0631 \u0646\u06cc\u0633\u062a\u060c \u0628\u0627\u0632\u06af\u0634\u062a \u0627\u0646\u062c\u0627\u0645 \u0645\u06cc\u200c\u0634\u0648.');\n      }\n      isBlocked = true; \n    });\n    \n</script>\n"
              }
            />
