  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "text",
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => "manually"
      },
      {
      ...
      },
      {
        ...
        type: "private",
        variableType: "number",
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => $state.week
      },
      {
        path: "day2.value",
        type: "private",
        variableType: "number",
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => $state.day
      },
      {
        path: "week",
        type: "private",
                      ...
                      <Button
                        ...
                        onClick={async event => {
                              ...
                              ? (() => {
                                  const actionArgs = {
                                    ...
                                    value: (() => {
                                      ...
                                      var dateShamsi = window.jalaali.toJalaali(
                                        gyNew,
                                        gmNew,
                                        gdNew
                                      );
                                  ...
                                  const actionArgs = {
                                    ...
                                    value: (() => {
                                      ...
                                      var dd = window.jalaali.toJalaali(
                                        ...
                                        parseInt(formattedDueDate.split("-")[2])
                                      );
                                      return {
                                        day: dd.jd,
                                        month: dd.jm,
                          ...
                          if (
                            ...
                            typeof $steps["updateDateOfBirth3"] === "object" &&
