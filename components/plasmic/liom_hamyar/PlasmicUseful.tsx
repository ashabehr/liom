...
import sty from "./PlasmicUseful.module.css"; // plasmic-import: 2qiQ4nSmOYBA/css
...
function PlasmicUseful__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames("all", "__wab_text", sty.text__xjkag)}>
      ...
      <div className={classNames("all", "__wab_text", sty.text__nxVc7)}>
        <React.Fragment>
          {(() => {
            try {
              return `${$state.text} > `;
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicUseful__VariantsArgs, ReservedPropsType> &
