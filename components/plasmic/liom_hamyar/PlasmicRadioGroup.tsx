      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__bmcsR)}
          >
            <Radio
            ...
            <Radio
              className={classNames("__wab_instance", sty.radio__uWhUs)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__eqwh5)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
