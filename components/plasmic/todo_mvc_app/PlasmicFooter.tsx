...
import ToggleButton from "../../ToggleButton"; // plasmic-import: VIXeRGB2_Dyv/component
  ...
  return (
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__yMz2, {
            ...
            [sty.freeBoxstate_hasCompleted__yMz2Ud2M]: hasVariant(
              $state,
              "state",
              "hasCompleted"
            ),
            [sty.freeBoxstate_singularLeft__yMz2GcpLn]: hasVariant(
              $state,
              "state",
              "singularLeft"
            )
      ...
      <div className={classNames(projectcss.all, sty.freeBox__vn1Aa)}>
        ...
        <ToggleButton
          className={classNames("__wab_instance", sty.toggleButton___4QkhY)}
          onClick={async () => {
            const $steps = {};
